    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(string returnUrl)
        {
            if (UserManager.Users.Count() == 0) {
                ...
                await UserManager.AddClaimAsync(adminUser.Id, new Claim(ClaimTypes.Role, "Admin"));
                ...
                // Executive
                var execUser = new ApplicationUser { UserName = "exec@example.com", Email = "exec@example.com" };
                var execResult = await UserManager.CreateAsync(execUser, "Password123!");
                await UserManager.AddClaimAsync(execUser.Id, new Claim(ClaimTypes.Email, "exec@example.com"));
                await UserManager.AddClaimAsync(execUser.Id, new Claim(ClaimTypes.Role, "Executive"));
                await UserManager.AddClaimAsync(execUser.Id, new Claim(ClaimTypes.GivenName, "Application"));
                await UserManager.AddClaimAsync(execUser.Id, new Claim(ClaimTypes.Surname, "Executive"));

                // Coordinator
                var coordUser = new ApplicationUser { UserName = "coord@example.com", Email = "coord@example.com" };
                var coordResult = await UserManager.CreateAsync(coordUser, "Password123!");
                await UserManager.AddClaimAsync(coordUser.Id, new Claim(ClaimTypes.Email, "coord@example.com"));
                await UserManager.AddClaimAsync(coordUser.Id, new Claim(ClaimTypes.Role, "Coordinator"));
                await UserManager.AddClaimAsync(coordUser.Id, new Claim(ClaimTypes.GivenName, "Application"));
                await UserManager.AddClaimAsync(coordUser.Id, new Claim(ClaimTypes.Surname, "Coordinator"));

                // Clerk
                var clerkUser = new ApplicationUser { UserName = "clerk@example.com", Email = "clerk@example.com" };
                var clerkResult = await UserManager.CreateAsync(clerkUser, "Password123!");
                await UserManager.AddClaimAsync(clerkUser.Id, new Claim(ClaimTypes.Email, "clerk@example.com"));
                await UserManager.AddClaimAsync(clerkUser.Id, new Claim(ClaimTypes.Role, "Clerk"));
                await UserManager.AddClaimAsync(clerkUser.Id, new Claim(ClaimTypes.GivenName, "Application"));
                await UserManager.AddClaimAsync(clerkUser.Id, new Claim(ClaimTypes.Surname, "Clerk"));
            }
